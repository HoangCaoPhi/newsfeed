...
namespace Newsfeed.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240609010620_Update_PostType_DisplayMode_Enum")]
    partial class Update_PostType_DisplayMode_Enum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Newsfeed.Domain.AggregatesModel.PostAggregate.Post", b =>
                {
                    ...
                    b.OwnsOne("Newsfeed.Domain.AggregatesModel.PostAggregate.Enums.DisplayMode", "DisplayMode", b1 =>
                        {
                            b1.Property<int>("PostId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Newsfeed.Domain.AggregatesModel.PostAggregate.PostType", "PostType", b1 =>
                        {
                            b1.Property<int>("PostId")
                                .HasColumnType("int");
